...
## Update: how to log data from multiple instances to the same stream

After using CloudWatch Logs for some time I found that it is very inconvenient to have one stream per instance.
