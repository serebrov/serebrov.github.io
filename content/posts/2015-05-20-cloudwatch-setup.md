...
The last one ([cwl-webrequest-metrics.config, click to preview](/cloudwatchlogs-apache/cwl-webrequest-metrics.config)) is an example of CloudWatch Logs setup for Apache's access log.
